...
function Register() {
  ...
  return (
    <div className="container mx-auto min-h-screen flex flex-col md:flex-row">
      ...
      {/* Right Side */}
      <div className="w-full md:w-1/2 bg-cover bg-center flex flex-col justify-center px-6 md:px-20 py-10" style={{ backgroundImage: `url(${LoginBg})` }}>
        ...
        <div className="md:mt-0 lg:mt-8 w-full max-w-sm mx-auto">
          ...
          <form className="space-y-6 w-full" onSubmit={handleSubmit}>
            <input type="text" name="name" placeholder="Enter your name" value={formData.name} onChange={handleChange} className="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" />
            <input type="email" name="email" placeholder="Enter your email" value={formData.email} onChange={handleChange} className="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" />
            <input type={showPassword ? "text" : "password"} name="password" placeholder="Enter your password" value={formData.password} onChange={handleChange} className="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" />
            <button type="submit" className="w-full py-3 bg-gradient-to-r from-[#0969E4] to-[#D861E1] text-white font-medium rounded-lg hover:opacity-90 transition">REGISTER</button>
          </form>
        </div>
      </div>
    </div>
